...
An independent After Effects script to make a null the parent of a selected layer; this script ensures that the null immediately moves to the exact position of the selected layer after created.
